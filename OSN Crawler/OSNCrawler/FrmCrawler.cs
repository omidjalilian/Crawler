...
//.................................................................................................................
        private void FrmOSNCrawler_Load(object sender, EventArgs e)
        {
            ...
            Spider3.ForestFireQueue += new ForestFireCrawler.ShowQueueHandler(m_ShowQueue);
            ...
            Spider4.SnowBallQueue += new SnowBallCrawler.ShowQueueHandler(m_ShowQueue);
...
//................................................................................................................
        //Find FriendId From UserUrl 
        private ArrayList GetFriendIds(ArrayList FriendUrl)
        {
            ArrayList FriendId = new ArrayList();
            for (int i = 0; i < FriendUrl.Count; i++)
            {
                string Temp = FriendUrl[i].ToString();
                int start = Temp.LastIndexOf('/');
                string Friendid = Temp.Substring(start + 1);
